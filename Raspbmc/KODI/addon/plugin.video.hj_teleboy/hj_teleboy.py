...
#############################################
#PLUGINID = "plugin.video.hj_teleboy"
#
#MODE_PLAY = "play"
...
#curl  -u hjfabius:fabius -H "Content-Type: application/json" -d '{"jsonrpc":"2.0","method":"Addons.ExecuteAddon","params":{"addonid":"plugin.video.hj_teleboy", "params" : {"OnTimerCall":"Yes"} } ,"id":1}' http://192.168.0.21:85/jsonrpc

__addon__       = xbmcaddon.Addon(id='plugin.video.hj_teleboy')
...
#http://mirrors.xbmc.org/docs/python-docs/xbmcgui.html#Dialog 
#import xbmcgui 
