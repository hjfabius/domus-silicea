#ifndef DOMUSSILICEALOGGING_H
#define DOMUSSILICEALOGGING_H
#include <inttypes.h>
#include <stdarg.h>
...
#define DOMUSSILICEA_LOG_LEVEL_NOOUTPUT 0 
#define DOMUSSILICEA_LOG_LEVEL_ERRORS 1
#define DOMUSSILICEA_LOG_LEVEL_INFOS 2
#define DOMUSSILICEA_LOG_LEVEL_DEBUG 3
#define DOMUSSILICEA_LOG_LEVEL_VERBOSE 4

// default loglevel if nothing is set from user
#define DOMUSSILICEA_LOGLEVEL DOMUSSILICEA_LOG_LEVEL_DEBUG 


#define CR "\r\n"
#define DOMUSSILICEA_LOGGING_VERSION 1
...
extern DomusSiliceaLogging Log;
#endif
